...
- [ ] Добавить проверку IP-адресов по локальной IOC-базе
- [ ] Добавить проверку доменов из DNS/HTTP/TLS по IOC-спискам
- [ ] Выявлять предполагаемый заражённый внутренний хост
- [ ] Добавить explainability: почему событие помечено как вредоносное
- [ ] Выводить уровень уверенности: anomaly / suspicious / malicious
